...
const MarketBasketAnalysis = () => {
    ...
    const projectData = {
        ...
        period: "Januari 2026",
        description: "Project ini menggunakan algoritma Apriori untuk mengidentifikasi pola hubungan antar produk dalam transaksi retail. Analisis ini membantu dalam menentukan strategi bundling produk dan optimalisasi tata letak barang untuk meningkatkan volume penjualan melalui insight pola belanja pelanggan.",
        tools: [
        ...
        links: {
            ...
            reportPdf: "/files/market-basket-report.pdf"
        },
        content: [
            {
                image: "/images/market-basket-eda.png",
                title: "Exploratory Data Analysis (EDA)",
                explanation: "Proses dimulai dengan eksplorasi data transaksi untuk melihat produk yang paling populer (top items) dan tren frekuensi belanja. Insight ini krusial untuk memvalidasi data sebelum menjalankan algoritma asosiasi."
            },
            {
                image: "/images/market-basket-apriori.png",
                title: "Association Rules Discovery",
                explanation: "Mengimplementasikan algoritma Apriori untuk mengekstrak aturan asosiasi. Saya berfokus pada metrik Support, Confidence, dan Lift untuk menemukan pasangan produk yang memiliki korelasi belanja yang kuat dan signifikan."
            },
            {
                image: "/images/market-basket-viz.png",
                title: "Pattern Visualization & Business Strategy",
                explanation: "Hasil akhir divisualisasikan untuk memberikan rekomendasi konkret bagi bisnis, seperti penempatan produk pendamping secara berdekatan atau pembuatan paket hemat (bundling) berdasarkan item yang sering dibeli bersamaan."
            }
        ]
    };
