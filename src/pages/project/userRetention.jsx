...
const UserRetentionAnalysis = () => {
    ...
    const projectData = {
        title: "User Retention & Cohort Analysis Report",
        period: "Desember 2025 - Januari 2026",
        description: "Project ini berfokus pada analisis loyalitas pelanggan melalui teknik Cohort Analysis. Dengan melacak perilaku kelompok pengguna dari waktu ke waktu, saya mengidentifikasi titik kritis di mana pengguna berhenti menggunakan layanan (churn) dan memberikan rekomendasi strategis untuk meningkatkan Customer Lifetime Value (CLV).",
        tools: [
        ...
        links: {
            ...
            reportPdf: "/files/user-retention-report.pdf"
        },
        content: [
            {
                image: "/images/retention-eda.png",
                title: "Data Preparation & Cleaning",
                explanation: "Langkah awal melibatkan pengolahan data transaksi mentah menjadi format time-series. Saya melakukan pembersihan data untuk memastikan setiap transaksi memiliki User ID dan Timestamp yang valid guna pembentukan kelompok cohort yang akurat."
            },
            {
                image: "/images/retention-cohort.png",
                title: "Cohort Analysis Heatmap",
                explanation: "Saya membangun matriks retensi berbasis bulanan menggunakan Python. Visualisasi heatmap ini menunjukkan persentase pengguna yang kembali bertransaksi setelah bulan pertama mereka bergabung, membantu mendeteksi penurunan retensi pada periode tertentu."
            },
            {
                image: "/images/retention-insights.png",
                title: "Strategic Recommendations",
                explanation: "Berdasarkan pola yang ditemukan, saya merumuskan strategi intervensi untuk segmen pengguna dengan tingkat churn tinggi. Hasil analisis ini divisualisasikan melalui dashboard interaktif untuk membantu tim produk memantau kesehatan basis pengguna secara real-time."
            }
        ]
    };
