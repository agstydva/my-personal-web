...
const WorkWellDetail = () => {
    ...
    const projectData = {
        ...
        description: "A modern web application that helps employees maintain physical and mental well-being through wellness tracking, healthy habit reminders, interactive dashboards, and educational resources. Developed using a user-centered Design Thinking approach with a focus on SDG 3 (Good Health and Well-being).",
        tools: [
        ...
        links: {
            ...
            reportPdf: "/files/workwell-report.pdf"
        },
        content: [
            {
                image: "/images/workwell.png",
                title: "Personalized Wellness Dashboard",
                explanation: "Dashboard interaktif utama menyediakan ringkasan harian mengenai kesehatan fisik dan mental pengguna. Menampilkan visualisasi pelacakan hidrasi, durasi screen time, aktivitas fisik, serta tingkat stres harian secara real-time guna membantu karyawan membangun kebiasaan hidup sehat di lingkungan kerja."
            },
            {
                image: "/images/workwell.png",
                title: "Smart Habits & Reminders",
                explanation: "Fitur pengingat berkala untuk melakukan peregangan fisik (stretching) mata dan otot demi meminimalkan kelelahan kerja akibat duduk terlalu lama. Pengingat ini dirancang berdasarkan Design Thinking agar tidak mengganggu fokus kerja namun tetap efektif menjaga kebugaran tubuh."
            },
            {
                image: "/images/workwell.png",
                title: "Educational Resources & Analytics",
                explanation: "Menyediakan modul edukasi kesehatan digital serta analitik tren jangka panjang untuk melihat pola produktivitas dan kesejahteraan individu. Membantu perusahaan dalam merancang program wellness yang lebih tepat sasaran bagi kesejahteraan karyawan."
            }
        ]
    };
        ...
        <div className="min-h-screen w-full bg-[#fcfcfc] flex flex-col font-sans selection:bg-emerald-50">
            ...
            <main className="flex-grow w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 xl:px-8 pt-30 pb-24">
                ...
                <header className="mb-20">
                    <div className="mb-12">
                        <span className="text-emerald-600 font-semibold tracking-widest uppercase text-xs">Portfolio Fullstack Web Developer</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center mb-32">
                    ...
                    <div className="lg:col-span-3 relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white group">
                        <img 
                            src="/images/workwell.png" 
                            alt="WorkWell Platform" 
