...
const SupermarketSalesAnalysis = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    ...
    const projectData = {
        title: "Supermarket Sales Comprehensive Report",
        ...
        links: {
            ...
            reportPdf: "/files/supermarket-sales-report.pdf"
        },
        content: [
            {
...
export default SupermarketSalesAnalysis;