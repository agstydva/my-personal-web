...
const UnderConstruction = () => {
  return (
    // JURUS PAMUNGKAS: 'fixed inset-0' memaksa elemen ini menutupi SELURUH layar
    // tidak peduli ada settingan layout aneh-aneh di file lain.
    // z-50 memastikannya tampil paling depan.
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      <div className="max-w-md w-full text-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          Mohon maaf, halaman ini masih dalam tahap pengembangan oleh <strong>Agastya Dava</strong>. Silakan kembali lagi nanti!
        </p>

        {/* Tombol Bagus (Simpel & Elegan) */}
        <Link 
          to="/" 
