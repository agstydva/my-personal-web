...
const AcaraFakul = () => {
    ...
    const orgData = {
        ...
        activityTitle: "Event Division Staff",
        description: "PKKMB FMIPA UNJ is an orientation program designed to introduce new students of the Faculty of Mathematics and Natural Sciences at Universitas Negeri Jakarta to the academic environment, faculty values, regulations, and campus culture. The program aims to help students adapt to university life by fostering discipline, responsibility, and collaboration, while also providing essential information about academic systems, student organizations, and opportunities for personal and professional development within FMIPA UNJ.",
        jobdesk: [
            "Collaborated with a 15 member event division team to design, plan, and execute faculty orientation programs.",
            "Supported program logistics, time management, and activity coordination to ensure successful delivery of multiple large scale sessions.",
            "Assisted in evaluating participant engagement and optimizing event strategies, contributing to a more impactful orientation experience."
        ],
        gallery: [
            { src: "/images/acarafakul.jpeg", size: "large", caption: "Divisi Acara PKKMB FMIPA 2025" },
            { src: "/images/acarafakul2.jpeg", size: "portrait", caption: "Acaraa" }, 
            { src: "/images/acarafakul1.jpeg", size: "standard", caption: "Panitia PKKMB FMIPA 2025" },
            { src: "/images/acarapkkmbfmipa.jpg", size: "standard", caption: "Acara Goes PKKMB FMIPA 2025" },
        ]
    };
    ...
    return (
        <div className="min-h-screen w-full bg-[#fcfcfc] flex flex-col overflow-x-hidden font-sans">
            ...
            <main className="flex-grow w-full max-w-7xl mx-auto px-6 pt-32 pb-20">
                ...
                {/* BACK NAVIGATION - PURPLE STYLE
                <div className="mb-10">
                    <button 
                        onClick={() => navigate(-1)}
                        className="group bg-slate-900 text-white px-7 py-3.5 rounded-2xl font-bold 
                                   hover:bg-purple-600 hover:-translate-y-1.5
                                   hover:shadow-[0_20px_50px_rgba(147,51,234,0.4)] 
                                ...
                                return (
                                    <div key={index} className={`${gridClasses} group relative rounded-[2.5rem] overflow-hidden shadow-lg border-4 border-white transition-all duration-700 hover:shadow-purple-500/20 hover:-translate-y-2`}>
                                        <img 
                                            ...
                                            onError={(e) => {e.target.src="https://via.placeholder.com/800x600/F5F3FF/7C3AED?text=Event+Moment"}}
                                        />
